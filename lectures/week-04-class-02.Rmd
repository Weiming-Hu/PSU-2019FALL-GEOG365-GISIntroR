...
```{r, out.width = "400px", fig.asp = 0.6, results = F}
...
# We can also add attributes to SpatialPoints to make 
# SpatialPointsDataFrame.
# 
zion.spdf <- SpatialPointsDataFrame(
  coords = coordinates(zion.pts),
  data = data.frame(ID = 1:length(zion.pts),
                    Elevation = vals),
  proj4string = crs(zion.pts))

# SpatialPointsDataFrame can be thought as
# the points plus their attributes
# 
# To access the attribute table
zion.spdf@data

# To access the coordinates
zion.spdf@coords

# Check all available slot names
slotNames(zion.spdf)
```
